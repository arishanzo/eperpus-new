...
<main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div class="flex flex-col gap-5 md:gap-7 2xl:gap-10 pt-8">
              ...
              >
                ...
                >
                <form action="{{ route('data_buku.update', $buku->id_buku) }}" method="POST">
                @csrf
                @method('PUT')
             <div class="mb-4">
            <label for="name" class="block text-gray-700 font-medium mb-2">Judul Buku</label>
            <input type="text" id="judulbuku" name="judulbuku"  value="{{ $buku->judul_buku }}"
        ...
        <div class="mb-4">
            ...
            <select id="tahunterbit" name="tahunterbit"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
                <option value="{{ $buku->tahunterbit }}"> {{ $buku->tahunterbit }}</option>
                <?php   
            ...
            <input type="text" id="jumlahsalinan" name="jumlahsalinan" value="{{ $buku->jumlahsalinan }}"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
        </div>

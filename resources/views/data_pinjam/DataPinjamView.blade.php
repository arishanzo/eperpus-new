...
@endif
            ...
            <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-4 rounded" href="{{ route('data_pinjam_tambah') }}">Tambah Data Pinjam</a>
                  ...
                  <table class="table w-full  table-auto" id="dataTableOne">
                    ...
                    @forelse ($data_pinjam as $data_pinjam)
                                    <tr>
                                        ...
                                        <td>{{ $data_pinjam->data_santri->nama_santri }}</td>
                                        <td>{{ $data_pinjam->data_buku->judul_buku }}</td>
                                        ...
                                        <td >
                                          <div class="pb-4">
                                        <a href="{{ route('data_pinjam_kembalikan', $data_pinjam->id_pinjambuku) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Kembalikan Buku</a>
                                        </div>
                                                
                                              <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('data_pinjam.destroy', $data_pinjam->id_pinjambuku) }}" method="POST" style="display:inline;">
                                               @csrf
                                               @method('DELETE')

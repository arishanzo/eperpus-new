...
<main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Edit Data Santri</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="flex flex-col gap-5 md:gap-7 2xl:gap-10 pt-8">
              ...
              >
                ...
                >
                <form action="{{ route('data_santri.update', $santri->id_santri) }}" method="POST">
                @csrf
                @method('PUT')
             <div class="mb-4">
            <label for="name" class="block text-gray-700 font-medium mb-2">Nama Santri</label>
            <input type="text" id="namasantri" name="namasantri" value="{{ $santri->nama_santri }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="kelas" name="kelas" value="{{ $santri->kelas }}"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
        </div>

        <div class="mb-4">
            <label for="name" class="block text-gray-700 font-medium mb-2">Asrama</label>
            <input type="text" id="asrama" name="asrama" value="{{ $santri->asrama}}"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <select id="status" name="status"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
                <option value="{{ $santri->status}}">{{ $santri->status }}</option>

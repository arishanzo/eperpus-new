...
@endif
            ...
            <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-4 rounded" href="{{ route('data_santri_tambah') }}">Tambah Data Santri</a>
                  ...
                  <table class="table w-full  table-auto" id="dataTableOne">
                    ...
                    @forelse ($data_santri as $data_santri)
                                    <tr>
                                        ...
                                        <td >
                                                    <a href="{{ route('data_santri_edit', $data_santri->id_santri) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">EDIT</a>
                                              
                                                
                                               <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('data_santri.destroy', $data_santri->id_santri) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
